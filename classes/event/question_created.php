...
/**
 * Contains class mod_recommend\event\question_created
 *
...
/**
 * Class mod_recommend\event\question_created
 *
 * @package    mod_recommend
 * @copyright  2016 Marina Glancy
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
class question_created extends \core\event\base {
    ...
    public function get_description() {
        return "User with id '{$this->userid}' created question with id '{$this->objectid}'"
    ...
    public static function get_name() {
        return get_string('eventquestioncreated', 'recommend');
    }
