...
/**
 * Contains class mod_recommend\event\question_deleted
 *
...
/**
 * Class mod_recommend\event\question_deleted
 *
 * @package    mod_recommend
 * @copyright  2016 Marina Glancy
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
class question_deleted extends \core\event\base {
    ...
    public function get_description() {
        return "User with id '{$this->userid}' deleted question with id '{$this->objectid}'"
