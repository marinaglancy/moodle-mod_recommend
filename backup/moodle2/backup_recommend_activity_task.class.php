...
/**
 * Defines backup_recommend_activity_task class
 *
...
require_once($CFG->dirroot . '/mod/recommend/backup/moodle2/backup_recommend_stepslib.php');

/**
 * Provides the steps to perform one complete backup of the recommend instance
 *
 * @package   mod_recommend
 * @category  backup
 * @copyright 2016 Marina Glancy
...
class backup_recommend_activity_task extends backup_activity_task {
    ...
    /**
     * Defines a backup step to store the instance data in the recommend.xml file
     */
