...
$strname = get_string('modulenameplural', 'mod_recommend');
$PAGE->set_url('/mod/recommend/index.php', array('id' => $id));
...
if (! $recommends = get_all_instances_in_course('recommend', $course)) {
    notice(get_string('norecommends', 'recommend'), new moodle_url('/course/view.php', array('id' => $course->id)));
}
...
$currentsection = '';
foreach ($modinfo->instances['recommend'] as $cm) {
    $row = array();
    if ($usesections) {
